    ...
    <table cellpadding="0" cellspacing="0">
        <thead>
            <tr>
                ...
                <th scope="col"><?= $this->Paginator->sort('active_membership') ?></th>
                <th scope="col"><?= $this->Paginator->sort('last_paid_membership') ?></th>
                <th scope="col"><?= $this->Paginator->sort('rating') ?></th>
                <th scope="col"><?= $this->Paginator->sort('elo') ?></th>
                <th scope="col"><?= $this->Paginator->sort('receive_sms') ?></th>
