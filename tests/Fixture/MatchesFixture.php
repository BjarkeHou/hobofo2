...
class MatchesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'team1_score' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        'team2_score' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        'winner_id' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        'matchtype_id' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
    ...
    public $records = [
        [
            ...
            'winner_id' => 1,
            'matchtype_id' => 1,
            'created' => '2017-11-05 16:29:16',
            'started' => '2017-11-05 16:29:16',
            'ended' => '2017-11-05 16:29:16'
        ],
    ];
}
